# PHP Template: Mezzio Application

This repository creates a production-ready web application foundation based on the Mezzio middleware runtime. It is engineered for building complex, enterprise-grade APIs and web services that require a robust middleware pipeline and strict dependency injection.

The template integrates the entire ecosystem's tooling, including PSR-7/15/17 implementations, database migrations, and structured logging. It is fully pre-configured for deployment via Docker Swarm, ensuring a seamless transition from development to a scalable production environment.
